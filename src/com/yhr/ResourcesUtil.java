...
public class ResourcesUtil implements Serializable {
	...
	public static void main(String[] args) {
		String fileName="db";
		System.out.println(ResourcesUtil.gekeyList(fileName));
		List<String> gekeyList = ResourcesUtil.gekeyList("db");
		for (String key : gekeyList) {
			String value = ResourcesUtil.getValue(fileName, key);
